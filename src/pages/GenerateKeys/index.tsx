...
const _GenerateKeysPage = ({
  ...
  const [chosenType, setChosenType] = useState<AccountType>('0x01');
    ...
    >
      ...
      {chosenType === '0x01' && (
        <Paper className="mb20">
          ...
          <Text className="mb10">
            <FormattedMessage
              defaultMessage="Each validator of this account type requires exactly {PRICE_PER_VALIDATOR} {TICKER_NAME}."
