...
export const TICKER_NAME                = IS_MAINNET ? 'ETH' : 'Hoodi ETH';
...
export const PRICE_PER_VALIDATOR        = Number(process.env.REACT_APP_PRICE_PER_VALIDATOR) || 32;
...
export const MIN_DEPOSIT_AMOUNT         = 0.0001 * ETHER_TO_GWEI;
